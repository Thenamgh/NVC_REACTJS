    ...
    return (
        <>
                        ...
                        <div className="col-md-8">
                            <div className="top-bar-left">
                                ...
                                <div className="text">
                                    ...
                                    <a href="tel:+84- 329328812"><p>+84- 329328812</p></a>
                                </div>
                                <div className="text">
                                    <i className="fa fa-envelope"></i>
                                    <a href="mailto:clbnangvungcao2023@gmail.com"><p>clbnangvungcao2023@gmail.com</p></a>
                                </div>
                            </div>
                        </div>
            ...
            <div className="navbar navbar-expand-lg bg-dark navbar-dark">
                <div className="container-fluid">
                    <Link to="/" className="navbar-brand">NẮNG VÙNG CAO</Link>
